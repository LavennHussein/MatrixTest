...
public class Matrix implements ActionListener //needed for the buttons
{
    ...
    private void ChooseOperation ()
    {
        ...
        choosePanel[6].add(Box.createHorizontalStrut(5)); // a spacer
